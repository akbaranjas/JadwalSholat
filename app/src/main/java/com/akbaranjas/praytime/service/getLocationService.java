package com.akbaranjas.praytime.service;
...
/**
 * Created by akbaranjas on 15/12/16.
 */

public class getLocationService extends Service implements LocationListener, ActivityCompat.OnRequestPermissionsResultCallback {
    ...
    public getLocationService(Context mContext, Activity activity) {
    ...
    private Location getLocation() {
        ...
        try {
            ...
            _isPermissionEnabled = ActivityCompat.checkSelfPermission(activity, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED;
    ...
    public void onRequestPermissionsResult(int requestCode, String[] permissions, int[] grantResults) {
        switch (requestCode) {
            case getLocationService.LOCATION_REQUEST_CODE: {
